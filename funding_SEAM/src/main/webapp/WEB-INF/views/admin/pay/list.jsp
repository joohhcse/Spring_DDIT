...
<div class="info-box bg-warning">
	...
	<ul class="list-group list-group-flush" style="list-style: none;">
		<li class="list-group-item">
	       ...
	       <button type="button" id="downloadBtn" class="btn btn-secondary" style="float:right;width:210px;" onclick="fnExcelReport('hiddenTable','funseamding_결제내역리스트')">Excel로 다운로드 받기</button>
    	</li>
    	<hr>	
    </ul>
       <!-- /.card-header -->
              		...
              		<td style="padding-right:10px;">
              			<div class="input-group" style="float:left;">
              				<div class="input-group-prepend">
			                    ...
			                    <input type="text" id="firstPjtPayDate" name="firstPjtPayDate" class="form-control input-group-append datepicker" style="width:120px;height:30px;margin-top:7px;" value="${param.firstPjtPayDate }">
		                    </div>
		                    ...
		                    <div class="input-group-prepend">
			                    ...
			                    <input type="text" id="lastPjtPayDate" name="lastPjtPayDate" class="form-control input-group-append datepicker" style="width:120px;height:30px;margin-top:7px;" value="${param.lastPjtPayDate }">
			                </div>    
	                    </div>
              		</td>
              		<td style="padding-right:10px;">
              			<div class="input-group" style="float:left;">
              				<div class="input-group-prepend">
			                    ...
			                    <input type="text" id="firstPjtPayAmount" name="firstPjtPayAmount" class="form-control" style="width:150px;height:30px;margin-top:7px;" value="${param.firstPjtPayAmount }">
							</div>
		                    <h7 style="margin-top:7px;">&nbsp;~&nbsp;</h7>
		                    <div class="input-group-prepend">
			                    <input type="text" id="lastPjtPayAmount" name="lastPjtPayAmount" class="form-control" style="width:150px;height:30px;margin-top:7px;" value="${param.lastPjtPayAmount }">
			                </div>    
	                	</div>
              		</td>
              		<td>
       ...
       <table class="table text-center">
        <thead>
          <tr>
            ...
            <th style="width:5%;">이 름</th>
            <th>이메일</th>
            <th>전화번호</th>
            <th>프로젝트</th>
            <th style="width:5%;">유 형</th>
            <th>결제<br/>방식</th>
            <th>결제<br/>금액</th>
            <th style="width:5%;">포인트<br/>사용</th>
            <th>결제<br/>전화번호</th>
            <th>결제<br/>일자</th>
            <th style="width:5%;">환불<br/>여부</th>
            <th style="width:11%;">상 태</th>
          </tr>
        </thead>
        <tbody>
		...
		<c:forEach items="${projectPayList }" var="projectPay">
			<tr class="trForClick" style='font-size:0.85em;cursor:pointer;'>
				...
				<td style="text-align:left;max-width: 300px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">${projectPay.pjt_title }</td>
