...
<div class="card-body box-profile">
  ...
  <p class="text-muted text-center">${member.code_state }</p>
	...
	<table>
		<tr class="row" style="padding-left:220px;">
          	...
          	<c:if test="${!empty memberDetailList }">
	          	<c:forEach items="${memberDetailList}" var="memberDetail">
		            <tr>
		              ...
		              <td><img src="<%= request.getContextPath() %>/project/picture/get?picture=${memberDetail.pjt_atc_sum_name}" onerror="this.src='https://source.unsplash.com/category/nature'" alt="image" style="width:100px;height:100px;">&nbsp;${memberDetail.pjt_title }</td>
