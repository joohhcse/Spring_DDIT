    ...
    <ul class="list-group list-group-flush" style="list-style: none;">
		<li class="list-group-item">
    		<h3 class="float-left">프로젝트 리스트</h3>
      		<button type="button" id="downloadBtn" class="btn btn-block btn-secondary" style="float:right;width:210px;" onclick="fnExcelReport('hiddenTable','funseamding_프로젝트리스트')">Excel로 다운로드 받기</button>
    	</li>
    	<hr>	
    </ul>
		...
		<c:forEach items="${projectList }" var="project">
			<tr class="trForClick" style='font-size:0.85em;cursor:pointer;'>
				...
				<td>
					<table>
						<tr>
							<th rowspan='2'><img src="<%= request.getContextPath() %>/project/picture/get?picture=${project.pjt_atc_sum_name}" onerror="this.src='https://source.unsplash.com/category/nature'" alt="image" style="width:100px;height:100px;"></th>
