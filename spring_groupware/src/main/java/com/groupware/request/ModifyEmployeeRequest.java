...
//	}
	...
	public String toString() {
		...
		return "ModifyEmployeeRequest [id=" + id + ", pwd=" + pwd + ", eno=" + eno + ", name=" + name + ", email="
				+ (email != null ? Arrays.asList(email).subList(0, Math.min(email.length, maxLen)) : null)
				+ ", enabled=" + enabled + ", phone_c=" + phone_c + ", phone_p=" + phone_p + ", picture=" + picture
				+ ", old_picture=" + old_picture + ", regDate=" + regDate + ", posi_no=" + posi_no + ", dept_no="
				+ dept_no + ", postCode=" + postCode + ", address1=" + address1 + ", address2=" + address2 + ", ssn="
				+ (ssn != null ? Arrays.asList(ssn).subList(0, Math.min(ssn.length, maxLen)) : null) + ", remark="
				+ remark + ", register=" + register + ", licenseDoc=" + licenseDoc + ", graduDoc=" + graduDoc
				+ ", scoreDoc=" + scoreDoc + ", careers="
				+ (careers != null ? Arrays.asList(careers).subList(0, Math.min(careers.length, maxLen)) : null)
